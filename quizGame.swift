...
class quizGame: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Question(Question: "Which social media shares your information with third party applications?", Answers: ["Facebook","Instagram","Snapchat","Tumblr"], Answer: 0),
        Question(Question: "Which social media collects information of the external features you use like headphones and chargers", Answers: ["Facebook","Instagram","Snapchat","Tumblr"], Answer: 2),
        Question(Question: "Which social media shares the websites you visit to third party applications?", Answers: ["Facebook","Instagram","Snapchat","Tumblr"], Answer: 1),
        Question(Question: "Which social media collects your billing and shipping address?", Answers: ["Facebook","Instagram","Snapchat","Tumblr"], Answer: 1),
        Question(Question: "Which social media collects data such as your device, network, bluetooth and networks around you?", Answers: ["Facebook","Instagram","Snapchat","Tumblr"], Answer: 0),
        Question(Question: "Which social media keeps track on the photos you send?", Answers: ["Facebook","Instagram","Snapchat","Tumblr"], Answer: 2)]
